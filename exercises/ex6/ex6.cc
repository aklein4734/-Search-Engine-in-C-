...
static bool Test_add(Vector v1, Vector v2, Vector v3);
static bool Test_sub(Vector v1, Vector v2, Vector v3);
...
int main(int argc, char* argv[]) {
  ...
  if (!Test_sub(v1, v2, v0) || !Test_add(v0, v2, v2) ||
